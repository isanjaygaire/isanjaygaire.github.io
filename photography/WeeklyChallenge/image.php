                                        ...
                                        <div class="blog_post_page portfolio_post blog_post_content">
                                            ...
                                            <div class="blog_post-topline">
                                                ...
                                                <div class="blog_post-meta">
                                                    <?php
                                                    $published_text = esc_html__('Published on %2$s in %5$s', 'geographic');
                                                    ...
                                                    printf('<span class="attachment-meta full-size-link"><a href="%1$s" title="%2$s">%3$s (%4$s &times; %5$s)</a></span>',
                                                        ...
                                                        esc_attr__('Link to full-size image', 'geographic'),
                                                        esc_html__('Full resolution', 'geographic'),
                                                        $metadata['width'],
                                                        $metadata['height']
                                                    );

                                                    edit_post_link(esc_html__('Edit', 'geographic'), '<span class="edit-link">', '</span>');
                                                    ?>
                                                </div>
                                            </div>
                                            <?php if (!empty($post->post_content)) { ?>
                                                <article class="contentarea">
                                                    <?php the_content(); ?>
                                                    <?php wp_link_pages(array('before' => '<div class="page-links">' . esc_html__('Pages:', 'geographic'), 'after' => '</div>')); ?>
                                                </article>
                                            <?php } ?>
                                            ...
                                            <div class="prev_next_links">
                                                <span class="gallery_back"><a
                                                        href="<?php echo esc_js("javascript:history.back()");?>">&laquo; <?php echo esc_html__('Back', 'geographic'); ?></a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
