<?php
/*
Template Name: Fullscreen Slider With Content
*/
...
<div class="site_wrapper fadeOnLoad slider_w_content">
    <div class="main_wrapper">
        <div class="content_wrapper">
            <div class="container is_page">
                <div class="content_block row">
                    <div class="fl-container">
                        <div class="row">
                            <div class="posts-block">
								<?php if ($title == 'yes') { ?>
                                    <div class="page_title_block slider_w_content_title">
        ...
        <script>
            jQuery(document).ready(function () {
				...
				jQuery('html').addClass('slider_with_content');
				setTimeout("jQuery('html').addClass('slider_with_content_hide')", 4000);
